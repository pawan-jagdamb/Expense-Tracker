...
const CreateExpense = () => {
  ...
  const handleCreateExpense = async () => {
    ...
    if (!account || !category || !input) {
      alert('Please fill in all required fields (Account, Category, Amount)');
      return;
    }
    ...
    try {
      ...
      const response = await axios.post(
        `${getBaseURL()}${API_ENDPOINTS.expenses}`,
        expense,
      );
      console.log("3")
      ...
      console.log("Error in creating expenses");
      if (error.code === 'NETWORK_ERROR' || error.message === 'Network Error') {
        console.log('Network Error: Make sure your backend server is running and accessible');
      ...
      <ScrollView>
        ...
        <View style={{marginHorizontal: 12, gap: 20, marginTop: 7}}>
          ...
          <Pressable
            ...
            <Pressable style={{flex: 1}} onPress={setCategoryStatus}>
              <TextInput
                editable={false}
                style={{
                  borderBottomWidth: 1,
          ...
          <Pressable
            ...
            <Pressable style={{flex: 1}} onPress={setAccountStatus}>
              <TextInput
                editable={false}
                style={{
                  borderBottomWidth: 1,
          ...
          <View style={{flexDirection: 'row', gap: 12}}>
            ...
            <Pressable style={{flex: 1}} onPress={noteDescriptionHandler}>
              <TextInput
                value={note}
